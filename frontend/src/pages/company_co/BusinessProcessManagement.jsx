...
function BusinessProcessManagement() {
  ...
  const handleSubmit = async () => {
    ...
    setSaving(true)
    try {
      const response = await fetch(apiUrl('/api/company-co/business-processes'), {
        method: 'POST',
        credentials: 'include',
        headers: {
      ...
      console.error('Create company business process error:', error)
  ...
  return (
    <>
      <ManagementPageHeader
        ...
        subtitle="View the common business-process list and add company-specific business processes with your own codes."
        actions={
          <Button
            variant="contained"
            color="secondary"
